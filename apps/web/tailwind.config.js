  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Custom library colors - emerald theme
        emerald: {
        ...
        'library-green': {
          DEFAULT: 'hsl(var(--library-green))',
          light: 'hsl(var(--library-green-light))',
        },
      ...
      keyframes: {
        ...
        glow: {
          from: { boxShadow: '0 0 20px hsl(var(--accent) / 0.2)' },
          to: { boxShadow: '0 0 30px hsl(var(--accent) / 0.4)' },
        },
      },
      animation: {
