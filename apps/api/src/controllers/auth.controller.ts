...
import { AuthControllerDependencies } from '../container/types.js';

export const authController = (dependencies: AuthControllerDependencies) => {
  const { authService, cryptoService, emailVerificationService } = dependencies;
